 ...
 */
export function inferVariantFromFilename(filename, flavor) {
    if (flavor === "summary") {
        return "summary";
    }
 ...
 * @param flavor Prompt flavor (summary/system/tools).
 */
export function inferLlmMetadata(service, filename, flavor) {
 ...
 */
export function normalizeUserLlmName(raw) {
    if (!raw)
        return undefined;
 ...
 */
export function llmMatchScore(userLlm, metadata) {
    if (!userLlm)
        return metadata ? 0.25 : 0.1;
    if (!metadata)
        return 0.05;
